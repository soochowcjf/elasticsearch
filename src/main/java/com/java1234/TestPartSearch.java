...
public class TestPartSearch {
    ...
    public void getClient() throws Exception {
        client = new PreBuiltTransportClient(settings.build())
                .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName(TestPartSearch.host), TestPartSearch.port));
    ...
    public void search()throws Exception{
        ...
        SearchResponse sr=srb.setQuery(QueryBuilders.matchQuery("title", "最狼")
                .analyzer(ANALYZER))
    ...
    public void search2()throws Exception{
        SearchRequestBuilder srb=client.prepareSearch("film2").setTypes("dongzuo");
        SearchResponse sr=srb.setQuery(QueryBuilders.multiMatchQuery("非洲星球铁拳", "title","content")
                .analyzer(ANALYZER))
                .setFetchSource(new String[]{"title","price"}, null)
                .execute()
                .actionGet();
