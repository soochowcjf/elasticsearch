...
public class TestFilm {
    ...
    public void getClient() throws Exception {
        client = new PreBuiltTransportClient(settings.build())
                .addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName(TestFilm.host), TestFilm.port));
    ...
    public void addIndex() {
        ...
        for (JsonElement jsonElement : jsonArray) {
            ...
            IndexResponse response = client.prepareIndex("film", "dongzuo").setSource(jsonElement.getAsJsonObject().toString(),XContentType.JSON).get();
